 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="{{url('/')}}" class="navbar-brand">Halaman Nasabah</a>
    </div>
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown active">
          <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Jenis Kartu<span class="caret"></span>
          </a>
          <ul class="dropdown-menu" aria-labelledby="dLabel">
...
<nav class="navbar navbar-default navbar-fixed-bottom">
 <footer class="container">
   ...
   created by <a href="#">
   <span><i class="fa fa-facebook-square" style="color: #1da1f2"></i>Mia Khalifa</span></a>
   gitHub by <a href="#">
   <span><i class="fa fa-github" style="color: #1da1f2"></i>Kelompok1</span></a> <!--/   please dont delete this    -->
 </marquee></footer>
</nav>
