...
<div class="panel panel-warning">
	<div classs="panel-heading">
		<strong><a href="{{url('nasabah')}}"><i style="color:#8a6d3b" class="fa text-default fa-chevron-left"></i></a> Detail Data nasabah</strong>
	</div>
	<table class="table">
		<tr>
			<td>Nama</td>
		...
		<tr>
			<td>Teller</td>
			<td>:</td>
			<td>{{$nasabah->teller_id}}</td>
		</tr>
		<tr>
			<td>kategori</td>
			<td>:</td>
			<td>{{$nasabah->kategori_id}}</td>
		</tr>
		<tr>
			<td>Kantor cabang</td>
			<td>:</td>
			<td>{{$nasabah->kantorcabang_id}}</td>
		</tr>		
		<tr>
