        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="{{url('nasabahC')}}"><i class="fa fa-user fa-fw"></i>Admin</a>
                        </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <font face="snap ITC" color="maroon" size="3">Selamat datang admin</font>
                        <li>
                            <a href="{{url('awal')}}"><i class="fa fa-dashboard fa-fw"></i> Home</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Nasabah<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('nasabah')}}">Data Nasabah</a>
                                </li>
                                
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Customer Sevice<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i>Data Cabang & Manajer<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i>Pengaturan Kartu<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li><a href="{{url('fitur')}}"> Fitur Kartu</a></li>
            <li class="divider"></li>
            <li><a href="{{url('kategori')}}">  Kategori Kartu</a></li>
            <li class="divider"></li>
